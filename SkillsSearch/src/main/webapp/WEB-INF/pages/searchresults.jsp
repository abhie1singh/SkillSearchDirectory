...
<div class="container text-center">
	<div class="row">
		...
		<div class="col-sm-7">
				...
				<div class="col-sm-12">
					<div class="panel panel-default text-left">
						<div class="panel-body">
							...
							<p>Do you mean  <a href="">John </a><a href="">John </a></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<p>
					<b>Tech Gurus using this technology</b>
				</p>
				<div class="col-sm-4">
					<div class="well">
						<img src="/public/images/abhie.jpg" class="img-circle" height="55"
							width="55" alt="Avatar">
						<p>
							<strong>Abhie</strong>
			...
			<div class="row">
				<p>
					<b>Users using this technology</b>
				</p>
				<div class="col-sm-4">
					<div class="well">
						<img src="/public/images/abhie.jpg" class="img-circle" height="55"
			...
			<div class="row">
				<p>
					<b>Projects using this technology</b>
				</p>
				<div class="col-sm-4">
					<div class="well">
						<p>
							<strong>Trade Surv</strong>
						</p>
						<p>
